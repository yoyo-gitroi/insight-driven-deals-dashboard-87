      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {riskData["Top 4 Acceleration Opportunities"].map((item: any, idx: number) => (
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {riskData["Top 4 Risk Factors"].map((item: any, idx: number) => (
              <div key={idx} className="pb-3 border-b last:border-0">
                <div className="mb-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <ol className="list-decimal pl-5 space-y-1 text-sm">
                {strategicActions["Top 5 Prioritized Actions for Sales Leadership"].map((action: string, idx: number) => (
